...
import ru.wkn.timekeepingsystem.model.branchoffice.BranchOffice;
import ru.wkn.timekeepingsystem.model.branchoffice.department.Department;
import ru.wkn.timekeepingsystem.model.branchoffice.department.employee.status.EmployeeStatus;
import ru.wkn.timekeepingsystem.model.timekeeping.data.EmployeeAuthorizationData;
...
public class Employee {
    ...
    public Employee(int employeeID, String name, String surname, String telephoneNumber, String employeeStatus, String login, String password, String department, String branchOffice, Task currentTask, EventFactoryIF<TimekeepingEvent> eventEventFactoryIF) {
